    ...
    if form.is_valid():
        ...
        def F(x, form_data):
            ...
            for e in range(0, numberElements):
                ...
                stiffness[elementDof[0] - 1, elementDof[0] - 1] = stiffness[elementDof[0] - 1, elementDof[0] - 1] + \
                                                                  k_st[e]
                stiffness[elementDof[0] - 1, elementDof[1] - 1] = stiffness[elementDof[0] - 1, elementDof[1] - 1] - \
                                                                  k_st[e]
                stiffness[elementDof[1] - 1, elementDof[0] - 1] = stiffness[elementDof[1] - 1, elementDof[0] - 1] - \
                                                                  k_st[e]
                stiffness[elementDof[1] - 1, elementDof[1] - 1] = stiffness[elementDof[1] - 1, elementDof[1] - 1] + \
                                                                  k_st[e]
